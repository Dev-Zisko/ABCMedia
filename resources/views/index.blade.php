			...
			<div class="container">
				...
				<div class="row">
					...
					<div id="store" class="col-md-12">
						...
						<div class="row">
							@if(count($consulta) == "0")
								<h1 style="margin-left: 25%;">No hay productos para mostrar.</h1>
								<br>
							@else
								...
								<div class="col-md-3 col-xs-6">
									<div class="product">
										<div class="product-img">
											<img src="./storage/{{ $producto->imagen1 }}" alt="" width="250" height="270">
										</div>
										<div class="product-body">
											<p class="product-category">{{$producto->categoria}}</p>
											<h3 class="product-name"><a href="{{url('producto',Crypt::encrypt($producto->id))}}">{{$producto->nombre}}</a></h3>
											<h4 class="product-price">$ {{$producto->precio}}</h4>
											<h4 class="product-price">Bs {{$producto->preciobs}}</h4>
										</div>
									</div>
								</div>
								<!-- /product -->
