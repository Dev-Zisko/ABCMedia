				...
				<div class="row">
					<div class="col-md-12">
						<div class="newsletter">
							<h2 class="aside-title">Términos y Condiciones</h2>
							<br>
							<p style="font-size: large;">Todos nuestros precios están expresados en Dolares EstadoUnidenses para pagar con Paypal y en Bolívares para pagar con InstaPago.</p>
							<p style="font-size: large;">Todos los pagos serán depositados en nuestras cuentas y luego se cobrará una comisión del 18% y se le enviará el dinero a cada uno de los vendedores.</p>
							<br>
							<h3>Alcance de los servicios ofrecidos</h3>
							<br>
							<p style="font-size: large; text-align: justify;">En virtud que ABCMedia sólo pone a disposición de los Usuarios una plataforma en línea de avisos clasificados mediante Internet, el Usuario reconoce y acepta que ABCMedia no es parte en ninguna operación, ni tiene control alguno sobre la calidad, seguridad o legalidad de los artículos anunciados, la veracidad o exactitud de los anuncios, la capacidad de los Usuarios para vender o comprar artículos. ABCMedia no puede asegurar que un Usuario completará una operación ni podrá verificar la identidad o Datos Personales ingresados por los Usuarios. ABCMedia no garantiza la veracidad de la publicidad de terceros que aparezca en el sitio y no será responsable por la correspondencia o contratos que el Usuario celebre con dichos terceros o con otros Usuarios. Por otra parte, se aclara que este acuerdo no crea ningún contrato de sociedad, de mandato, de franquicia, o relación laboral entre ABCMedia y el Usuario.</p>
							<br>
							<h3>Fallas en el sistema</h3>
							<br>
							<p style="font-size: large; text-align: justify;">En virtud que la plataforma prevista por ABCMedia se basa en sistemas de software, hardware, e Internet, no se puede garantizar el acceso y uso continuado o ininterrumpido del sitio. Se aclara que el sistema puede eventualmente no estar disponible debido a casos fortuitos o de fuerza mayor, así como dificultades técnicas o fallas de Internet, o por cualquier otra circunstancia ajena a ABCMedia; en tales casos se procurará restablecerlo con la mayor celeridad posible sin que por ello pueda imputársele algún tipo de responsabilidad. ABCMedia no será responsable por ningún error u omisión contenidos en su sitio web. Los Usuarios no podrán imputarle responsabilidad alguna ni exigir pago por lucro cesante, en virtud de perjuicios resultantes de dificultades técnicas o fallas en los sistemas o en Internet.</p>
						</div>
					</div>
				</div>
				<!-- /row -->
