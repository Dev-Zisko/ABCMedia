				...
				<div class="row">
					<div class="col-md-12">
						<div class="newsletter">
							<h2 class="aside-title">Pagar con Paypal</h2>
                            <br>
                            <form class="form-horizontal" method="POST">
                                ...
                                <p style="font-size: large; text-align: left; margin-left: 120px;"><strong>Precio:</strong> ${{$producto->precio}}</p>
                                ...
                                <input id="prodprecio" type="hidden" class="form-control" name="prodprecio" value="{{$producto->precio}}" readonly="readonly">
                                <input id="userpaypal" type="hidden" class="form-control" name="userpaypal" value="{{$usuario->paypal}}" readonly="readonly">
