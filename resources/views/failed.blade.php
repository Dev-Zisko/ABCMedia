                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="newsletter">
                            <h2 class="aside-title">Pago fallido. Revise si posee el dinero suficiente para pagar, verifique que los datos ingresados sean correctos e intente nuevamente. Gracias!</h2>
                        </div>
                    </div>
                </div>
                <!-- /row -->
