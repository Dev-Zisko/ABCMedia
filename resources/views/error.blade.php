                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="newsletter">
                            <h2 class="aside-title">Verifique datos ingresados, su conexión a internet o puede que nuestro sistema no este funcionando correctamente.</h2>
                            <br>
                            <h2 class="aside-title">Ha ocurrido un error en el proceso, vuelva a intentarlo nuevamente. Sentimos los inconvenientes.</h2>
                        </div>
                    </div>
                </div>
                <!-- /row -->
