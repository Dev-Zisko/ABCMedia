				...
				<div class="row">
					<div class="col-md-12">
						<div class="newsletter">
							<h2 class="aside-title">Pedido</h2>
							<form class="form-horizontal" method="POST">
                                {{ csrf_field() }}
                                <div>
                                	
                                	<label for="mensaje" class="col-md-12 control-label" style="text-align: center;">Si desea dejar un mensaje (Opcional):</label>

                                    <div class="col-md-12">
                                    	<textarea id="mensaje" type="text" class="form-control" name="mensaje" value="{{ old('mensaje') }}" autofocus rows="4" cols="50"></textarea>
                                    </div>
                                </div>

                                <div>
                                    <label for="cantidad" class="col-md-12 control-label" style="text-align: center;">Que cantidad de este producto desea?:</label>

                                    <div class="col-md-12">
                                        <input id="cantidad" type="num" class="form-control" name="cantidad" value="{{ old('cantidad') }}" required autofocus>
                                    </div>
                                </div>
