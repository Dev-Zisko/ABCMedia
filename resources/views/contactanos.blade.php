				...
				<div class="row">
					<div class="col-md-12">
						<div class="newsletter">
							<h2 class="aside-title">Contáctanos</h2>
							<form class="form-horizontal" method="POST">
                                {{ csrf_field() }}
                                <div>
                                    <label for="nombre" class="col-md-12 control-label" style="text-align: center;">Indicanos tu nombre:</label>
                                ...
                                <div>
                                    <label for="email" class="col-md-12 control-label" style="text-align: center;">Indicanos tu correo:</label>
                                ...
                                <div>
                                    ...
                                    <label for="mensaje" class="col-md-12 control-label" style="text-align: center;">Coloca tu mensaje aquí:</label>

                                    <div class="col-md-12">
                                    	<textarea id="mensaje" type="text" class="form-control" name="mensaje" value="{{ old('mensaje') }}" required autofocus rows="4" cols="50"></textarea>
                                    </div>
                                </div>
