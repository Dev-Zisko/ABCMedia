			...
			<div class="container">
				...
				<div id="responsive-nav">
					...
					<ul class="main-nav nav navbar-nav">
						...
						<li class="active"><a href="{{ url('/nosotros') }}">Sobre Nosotros</a></li>
				...
				<div class="row">
					<div class="col-md-12">
						<div class="newsletter">
							<h2 class="aside-title">Sobre Nosotros</h2>
							<br>
							<p style="font-size: large;">Somos una empresa pionera en la venta de productos automotrices en Venezuela.</p>
							<br>
							<p style="font-size: large; text-align: justify;">ABCMedia busca ahora con esta página actualizarse gracias a la tecnología y convertirse en una de las principales páginas de venta de repuestos para tu auto, para que puedas desde cualquier parte poder encontrar, comprar o vender esos repuestos que tanto buscas para tu auto o que tienes y quieres vender para obtener ingresos extras.</p>
							<br>
							<p style="font-size: large;"><a href="{{ url('register') }}">Registrate ahora!</a> y únete a nuestra gran comunidad.</p>
						</div>
					</div>
				</div>
				<!-- /row -->
