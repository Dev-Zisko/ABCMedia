                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="newsletter">
                            <h2 class="aside-title">Eliminar Pago</h2>
                            <br>
                            <form class="form-horizontal" method="POST">
                                {{ csrf_field() }}
                                <div class="form-group{{ $errors->has('metodo') ? ' has-error' : '' }}">
                                    <label for="metodo" class="col-md-12 control-label" style="text-align: center;">Metodo</label>

                                    <div class="col-md-12">
                                        <input id="metodo" type="text" class="form-control" name="metodo" placeholder="{{$payment->metodo}}" disabled>
                                    </div>
                                </div>

                                <div class="form-group{{ $errors->has('estado') ? ' has-error' : '' }}">
                                    <label for="estado" class="col-md-12 control-label" style="text-align: center;">Estado</label>

                                    <div class="col-md-12">
                                        <input id="estado" type="text" class="form-control" name="estado" placeholder="{{$payment->estado}}" disabled>
                                    </div>
                                </div>

                                <div class="form-group{{ $errors->has('fecha') ? ' has-error' : '' }}">
                                    <label for="fecha" class="col-md-12 control-label" style="text-align: center;">Fecha</label>

                                    <div class="col-md-12">
                                        <input id="fecha" type="text" class="form-control" name="fecha" placeholder="{{$payment->fecha}}" disabled>
                                    </div>
                                </div>

                                <div class="form-group{{ $errors->has('monto') ? ' has-error' : '' }}">
                                    <label for="monto" class="col-md-12 control-label" style="text-align: center;">Monto</label>

                                    <div class="col-md-12">
                                        <input id="monto" type="text" class="form-control" name="monto" placeholder="{{$payment->monto}}" disabled>
                                    </div>
                                </div>
