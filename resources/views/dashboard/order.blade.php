...
<html lang="en">
	...
	<body>
		...
		<div id="content">
			<br>
			<h2 style="text-align: center;">Pedidos registrados en el sistema</h2>
			<br>
			<br>
				...
				<table>
					...
					<tbody>
						@foreach ($orders as $order)
							...
							<td>{{$order->fecha}}</td>
							<td>
								<a class="boton-admin-table" href="{{url('dorder',Crypt::encrypt($order->id))}}"><i class="fa fa-trash"></i></a>
							</td>									
							</tr>
						@endforeach
					</tbody>
