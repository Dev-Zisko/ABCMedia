...
<html lang="en">
	...
	<body>
		...
		<div id="content">
			<br>
			<h2 style="text-align: center;">Usuarios registrados en el sistema</h2>
			<br>
			<div class="admin-container">
				<a class="boton-admin-table" href="{{ url('ruser') }}"><i class="fa fa-user-o"></i> Crear Usuario</a>
			</div>
			<br>
					...
					<tbody>
						@foreach ($users as $user)
							<tr>
								...
								<td>{{$user->rol}}</td>
								<td>
									<a class="boton-admin-table" href="{{url('uuser',Crypt::encrypt($user->id))}}"><i class="fa fa-edit"></i></a>
									<a class="boton-admin-table" href="{{url('duser',Crypt::encrypt($user->id))}}"><i class="fa fa-trash"></i></a>
								</td>
							</tr>
						@endforeach
					</tbody>
