...
<html lang="en">
	...
	<body>
		...
		<div id="content">
			<br>
			<h2 style="text-align: center;">Categorías registradas en el sistema</h2>
			<br>
			<div class="admin-container">
				<a class="boton-admin-table" href="{{ url('rcategory') }}"><i class="fa fa-check"></i> Crear Categoría</a>
			</div>
			<br>
					...
					<tbody>
						@foreach ($categories as $category)
							<tr>
								...
								<td>
									<a class="boton-admin-table" href="{{url('ucategory',Crypt::encrypt($category->id))}}"><i class="fa fa-edit"></i></a>
									<a class="boton-admin-table" href="{{url('dcategory',Crypt::encrypt($category->id))}}"><i class="fa fa-trash"></i></a>
								</td>
							</tr>
						@endforeach
					</tbody>
