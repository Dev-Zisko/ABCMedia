                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="newsletter">
                            <h2 class="aside-title">Eliminar Producto</h2>
                            <br>
                            <form class="form-horizontal" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-group{{ $errors->has('nombre') ? ' has-error' : '' }}">
                                    ...
                                    <div class="col-md-12">
                                        <input id="nombre" type="text" class="form-control" name="nombre" placeholder="{{$product->nombre}}" disabled>
                                ...
                                <select type="text" id="categoria" name="categoria">
                                    @foreach($categories as $category)
                                        @if($category->nombre == $product->categoria)
                                            <option value="{{$product->categoria}}" selected disabled>{{$product->categoria}}</option>
                                        @endif
                                    @endforeach
                                </select>
                                <br>
                                ...
                                <div class="form-group{{ $errors->has('descripcion') ? ' has-error' : '' }}">
                                    ...
                                    <div class="col-md-12">
                                        <textarea id="descripcion" type="text" class="form-control" name="descripcion" placeholder="{{$product->descripcion}}" rows="4" cols="50" disabled></textarea>
                                ...
                                <div class="form-group{{ $errors->has('precio') ? ' has-error' : '' }}">
                                    ...
                                    <div class="col-md-12">
                                        <input id="precio" type="number" class="form-control" name="precio" placeholder="{{$product->precio}}" disabled>
                                ...
                                <div class="form-group{{ $errors->has('preciobs') ? ' has-error' : '' }}">
                                    ...
                                    <div class="col-md-12">
                                        <input id="preciobs" type="number" class="form-control" name="preciobs" placeholder="{{$product->preciobs}}" disabled>
                                ...
                                <div class="form-group{{ $errors->has('cantidad') ? ' has-error' : '' }}">
                                    <label for="cantidad" class="col-md-12 control-label" style="text-align: center;">Cantidad (Opcional)</label>

                                    <div class="col-md-12">
                                        <input id="cantidad" type="number" class="form-control" name="cantidad" placeholder="{{$product->cantidad}}" disabled>
                                    </div>
                                </div>

                                <div class="form-group{{ $errors->has('peso') ? ' has-error' : '' }}">
                                    <label for="peso" class="col-md-12 control-label" style="text-align: center;">Peso (Opcional)</label>

                                    <div class="col-md-12">
                                        <input id="peso" type="number" class="form-control" name="peso" placeholder="{{$product->peso}}" disabled>
                                    </div>
                                </div>
                                ...
                                <div class="form-group{{ $errors->has('medidas') ? ' has-error' : '' }}">
                                    ...
                                    <div class="col-md-12">
                                        <input id="medidas" type="text" class="form-control" name="medidas" placeholder="{{$product->placeholder}}" disabled>
                                    </div>
                                </div>
                                ...
                                <div class="form-group{{ $errors->has('imagen1') ? ' has-error' : '' }}">
                                    ...
                                    <div class="col-md-12">
                                        <input id="imagen1" type="file" class="form-control" name="imagen1" placeholder="{{$product->imagen1}}" disabled>
                                    </div>
                                </div>
                                ...
                                <div class="form-group{{ $errors->has('imagen2') ? ' has-error' : '' }}">
                                    ...
                                    <div class="col-md-12">
                                        <input id="imagen2" type="file" class="form-control" name="imagen2" placeholder="{{$product->imagen2}}" disabled>
                                    </div>
                                </div>
                                ...
                                <div class="form-group{{ $errors->has('imagen3') ? ' has-error' : '' }}">
                                    ...
                                    <div class="col-md-12">
                                        <input id="imagen3" type="file" class="form-control" name="imagen3" placeholder="{{$product->imagen3}}" disabled>
                                    </div>
                                </div>
