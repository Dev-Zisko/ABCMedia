                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="newsletter">
                            <h2 class="aside-title">Eliminar Usuario</h2>
                            <br>
                            <form class="form-horizontal" method="POST">
                                ...
                                <div class="form-group{{ $errors->has('nombre') ? ' has-error' : '' }}">
                                    ...
                                    <div class="col-md-12">
                                        <input id="nombre" type="text" class="form-control" name="nombre" placeholder="{{$user->nombre}}" disabled>
                                ...
                                <div class="form-group{{ $errors->has('apellido') ? ' has-error' : '' }}">
                                    ...
                                    <div class="col-md-12">
                                        <input id="apellido" type="text" class="form-control" name="apellido" placeholder="{{$user->apellido}}" disabled>
                                ...
                                <div class="form-group{{ $errors->has('cedula') ? ' has-error' : '' }}">
                                    ...
                                    <div class="col-md-12">
                                        <input id="cedula" type="number" class="form-control" name="cedula" placeholder="{{$user->cedula}}" disabled>
                                ...
                                <div class="form-group{{ $errors->has('email') ? ' has-error' : '' }}">
                                    ...
                                    <div class="col-md-12">
                                        <input id="email" type="email" class="form-control" name="email" placeholder="{{$user->email}}" disabled>
                                ...
                                <div class="form-group{{ $errors->has('telefono') ? ' has-error' : '' }}">
                                    ...
                                    <div class="col-md-12">
                                        <input id="telefono" type="tel" class="form-control" name="telefono" placeholder="{{$user->telefono}}" disabled>
                                ...
                                <div class="form-group{{ $errors->has('paypal') ? ' has-error' : '' }}">
                                    ...
                                    <div class="col-md-12">
                                        <input id="paypal" type="email" class="form-control" name="paypal" placeholder="{{$user->paypal}}" disabled>
                                ...
                                <select type="text" id="rol" name="rol">
                                    ...
                                    @else
                                        <option value="Cliente" selected disabled>Cliente</option>
                                    @endif
                                </select>
                                <br>
                                <br>
                                <div class="form-group{{ $errors->has('password') ? ' has-error' : '' }}">
                                    ...
                                    <div class="col-md-12">
                                        <input id="password" type="password" class="form-control" name="password" placeholder="{{$user->password}}" disabled>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input id="password-confirm" type="password" class="form-control" name="password_confirmation" placeholder="{{$user->password}}">
                                    </div>
                                </div>
