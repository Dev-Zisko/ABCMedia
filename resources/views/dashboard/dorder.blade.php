                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="newsletter">
                            <h2 class="aside-title">Eliminar Pedido</h2>
                            <br>
                            <form class="form-horizontal" method="POST">
                                {{ csrf_field() }}
                                <div class="form-group{{ $errors->has('mensaje') ? ' has-error' : '' }}">
                                    <label for="mensaje" class="col-md-12 control-label" style="text-align: center;">Mensaje</label>

                                    <div class="col-md-12">
                                        <input id="mensaje" type="text" class="form-control" name="mensaje" placeholder="{{$order->mensaje}}" disabled>
                                    </div>
                                </div>
                                ...
                                <div class="form-group{{ $errors->has('cantidad') ? ' has-error' : '' }}">
                                    ...
                                    <div class="col-md-12">
                                        <input id="cantidad" type="text" class="form-control" name="cantidad" placeholder="{{$order->cantidad}}" disabled>
                                    </div>
                                </div>
                                ...
                                <div class="form-group{{ $errors->has('fecha') ? ' has-error' : '' }}">
                                    ...
                                    <div class="col-md-12">
                                        <input id="fecha" type="text" class="form-control" name="fecha" placeholder="{{$order->fecha}}" disabled>
                                    </div>
                                </div>
