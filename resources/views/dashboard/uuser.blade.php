                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="newsletter">
                            <h2 class="aside-title">Editar Usuario</h2>
                            <br>
                            <form class="form-horizontal" method="POST">
                                ...
                                <div class="form-group{{ $errors->has('cedula') ? ' has-error' : '' }}">
                                    ...
                                    <div class="col-md-12">
                                        <input id="cedula" type="number" class="form-control" name="cedula" value="{{$user->cedula}}" required>
                                ...
                                <div class="form-group{{ $errors->has('telefono') ? ' has-error' : '' }}">
                                    ...
                                    <div class="col-md-12">
                                        <input id="telefono" type="number" class="form-control" name="telefono" value="{{$user->telefono}}" required>
                                ...
                                <div class="form-group{{ $errors->has('paypal') ? ' has-error' : '' }}">
                                    ...
                                    <div class="col-md-12">
                                        <input id="paypal" type="email" class="form-control" name="paypal" value="{{$user->paypal}}" required>
