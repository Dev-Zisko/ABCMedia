			...
			<div class="container">
				...
				<div id="responsive-nav">
					...
					<ul class="main-nav nav navbar-nav">
						...
						<li class="active"><a href="{{ url('/mision') }}">Misión y Visión</a></li>
				...
				<div class="row">
					<div class="col-md-12">
						<div class="newsletter">
							<h2 class="aside-title">Misión</h2>
							<br>
							<p style="font-size: large; text-align: justify;">Queremos brindarle a toda nuestra comunidad un sitio seguro y práctico para que puedan realizar sus compras y ventas de productos automotrices desde cualquier lugar, solo teniendo que acceder a nuestra página web.</p>
							<br>
							<h2 class="aside-title">Visión</h2>
							<br>
							<p style="font-size: large; text-align: justify;">Buscamos crecer y expandirnos a más países para poder brindarles a más personas nuestro servicio de calidad. Así muchas personas podrán realizar sus compras y ventas cuando lo deseen.</p>
						</div>
					</div>
				</div>
				<!-- /row -->
